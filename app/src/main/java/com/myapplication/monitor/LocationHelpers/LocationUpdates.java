...
public class LocationUpdates {
    ...
    public static LocationListener locationListener = new LocationListener() {
        ...
        public void onLocationChanged(Location location) {
            ...
            LocationHandlers.distanceCalculator.sendEmptyMessage(0);
        }
    };
    public static String roundOffKM(String distanceValue){
        return String.valueOf(Math.round(Double.parseDouble(distanceValue)));
    }
}
